...
#ifndef PROFILE_SWIFT_H
#define PROFILE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Profile",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Profile11AppDelegate")
...
SWIFT_CLASS("_TtC7Profile13SceneDelegate")
...
SWIFT_CLASS("_TtC7Profile14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIImageView * _Null_unspecified profileImageView;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified profileLabel;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified profileCommentLavel;
- (void)viewDidLoad;
- (IBAction)tapButton1;
- (IBAction)tapButton2;
- (IBAction)tapButton3;
