...
class ViewController: UIViewController {
    ...
    @IBOutlet var profileCommentLavel: UILabel!
    ...
    @IBAction func tapButton1(){
        ...
        profileCommentLavel.text = "iPhoneメンターのフィルだよ"
    }
    ...
    @IBAction func tapButton2(){
        ...
        profileCommentLavel.text = "陸上競技が好きで、走り幅跳びが得意"
    }
    ...
    @IBAction func tapButton3(){
        ...
        profileCommentLavel.text = "リンゴが好きで、いつも持ち歩いている"
    }
